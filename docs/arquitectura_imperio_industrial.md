...
│   │   ├── bots/                # main del Bot Orchestration Service (Incremento 4, ADR-024): lifecycle interno + gameplay por pkg/botsdk + RetirementJob (Incremento 6a)
...
│   │   ├── world/               # World Simulation Service: catalog/land/buildings/production (Incremento 2) + fleet (Incremento 3: flota, cargamentos, motor de tránsito) + enforcement (Incremento 6a: cascada de insolvencia — mantenimiento, degradación, embargo) + sqlcgen del contexto
...
│   │   ├── bots/                # arquetipos de bots (Incremento 4, ADR-024): reglas fijas auditables; juegan SOLO vía pkg/botsdk + RetirementJob (Incremento 6a: retiro = absorción de caja)
