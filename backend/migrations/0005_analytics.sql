-- =============================================================================
-- Imperio Industrial — 0005_analytics.sql
...
--
-- Derivado de specs/schemas/04_analytics.sql, migrado a PostgreSQL 18:
-- identificadores UUIDv7 nativos en lugar de ULID.
-- =============================================================================
