-- =============================================================================
-- Imperio Industrial — 0004_ledger.sql
...
--
-- Derivado de specs/schemas/03_ledger.sql, migrado a PostgreSQL 18:
-- identificadores UUIDv7 nativos (uuidv7()) en lugar de ULID.
--
