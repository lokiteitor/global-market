-- =============================================================================
-- Imperio Industrial — 0003_world.sql
...
-- Origen: specs/schemas/02_world.sql, adaptado a PostgreSQL 18 (IDs uuid con
...
CREATE TABLE world.shipments (
    ...
    product_id           uuid NOT NULL REFERENCES world.products(id),
    quantity             stock_qty NOT NULL CHECK (quantity > 0),
    contract_id          uuid,   -- FK cross-schema a ledger.contracts: se añade en 0004
    freight_contract_id  uuid,   -- FK cross-schema a ledger.freight_contracts: se añade en 0004
