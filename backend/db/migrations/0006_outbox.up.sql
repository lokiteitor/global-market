-- =============================================================================
-- Imperio Industrial — 0006_outbox (up)
...
--
-- seq conserva BIGINT IDENTITY (orden total barato para polling); event_id y
-- aggregate_id son uuid (UUIDv7 nativo) — excepción única de ADR-018 §3.
-- =============================================================================
