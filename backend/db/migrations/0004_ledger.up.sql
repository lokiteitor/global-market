-- =============================================================================
-- Imperio Industrial — 0004_ledger (up)
...
--
-- IDs: uuid (UUIDv7 nativo, ADR-018); los IDs pre-generados de las funciones
-- todo-o-nada los produce la aplicación con UUIDv7 (google/uuid).
-- =============================================================================
...
--     El agrupador por activo es product_id::text con el literal 'MONEY' para
--     cuentas monetarias (product_id es uuid desde ADR-018).
...
-- -----------------------------------------------------------------------------
-- Funciones todo-o-nada. El Contract Service las invoca dentro de
-- transacciones SERIALIZABLE; si cualquier paso falla, no queda NINGUNA
-- garantía a medio bloquear (Arquitectura §10: 500 nunca deja estado parcial).
-- -----------------------------------------------------------------------------
...
-- Los IDs (UUIDv7) los genera y pasa la capa de aplicación (ADR-018).
