...
func (o Options) Validate() error {
	if o.CoalProducers < 0 || o.IronProducers < 0 || o.Traders < 0 {
		return fmt.Errorf("bots: la población no puede ser negativa (coal %d, iron %d, traders %d)",
			o.CoalProducers, o.IronProducers, o.Traders)
	}
